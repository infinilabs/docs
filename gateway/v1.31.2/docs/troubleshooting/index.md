...
title: "FAQs"
date: 0001-01-01
summary: "FAQs and Troubleshooting #  FAQs about INFINI Gateway and handling methods are provided here. You are welcome to submit your problems here.
FAQs #  The Auth section in Elasticsearch configuration #  Q：I see that when configuring Elasticsearch, I need to specify user information, what is use for?
A：INFINI Gateway is a transparent gateway, the parameters that are passed before the gateway placed, just keep them same, such as identity information or any other parameters that need to be passed."
---
