...
date: 0001-01-01
summary: "Helm Charts #  INFINI Gateway supports deployment on K8s by using helm chart .
...
If you want use other StorageClass(installed), you can create a YAML file (eg. vaules."
---
