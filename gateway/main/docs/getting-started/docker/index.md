...
date: 0001-01-01
summary: "Container Deployment #  INFINI Gateway supports container deployment.
...
docker pull infinilabs/gateway:1.31.2 Verifying the Image #  After downloading the image locally, you will notice that the container image of INFINI Gateway is very small, with a size less than 25 MB."
---
