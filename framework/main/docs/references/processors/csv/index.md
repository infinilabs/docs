...
title: "csv"
date: 0001-01-01
summary: "csv #     Category Scope     Parsing record    The &ldquo;csv&rdquo; pipeline processor: parse a CSV line into named fields (Vector&rsquo;s parse_csv equivalent). Headers come from configuration; missing columns get auto names col_N.
Configuration #     Field Type Default Description     field string  Source field to read from.   headers liststring  Extra headers sent with each request."
---
