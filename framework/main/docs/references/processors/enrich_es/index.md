...
title: "enrich_es"
date: 0001-01-01
summary: "enrich_es #     Category Scope     Enrichment record    The &ldquo;enrich_es&rdquo; pipeline processor: join the current record against an Elasticsearch/Easysearch index and merge the matched document into the record (port of the gateway&rsquo;s elasticsearch_lookup filter to the log pipeline).
Configuration #     Field Type Default Description     elasticsearch string &ldquo;default&rdquo; ID of the registered Elasticsearch/Easysearch cluster.   index_pattern string  Index name pattern to read from."
---
