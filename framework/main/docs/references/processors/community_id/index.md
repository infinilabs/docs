...
title: "community_id"
date: 0001-01-01
summary: "community_id #     Category Scope     Enrichment record    Configuration #     Field Type Default Description     source_ip string &ldquo;source.ip&rdquo; Network field holding the source IP.   source_port string &ldquo;source.port&rdquo; Network field holding the source port.   destination_ip string &ldquo;destination.ip&rdquo; Network field holding the destination IP.   destination_port string &ldquo;destination.port&rdquo; Network field holding the destination port."
---
