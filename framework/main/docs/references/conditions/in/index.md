...
title: "in"
date: 0001-01-01
summary: "in #     Kind Accepts     Value operator one field and a list of values    Tests whether a field value is contained in a list of allowed values. Supports both string and integer values.
Parameters #     Parameter Type Description     field name list The allowed values for that field.    Examples #  in: _ctx."
---
