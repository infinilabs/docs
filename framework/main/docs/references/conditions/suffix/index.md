...
title: "suffix"
date: 0001-01-01
summary: "suffix #     Kind Accepts     Value operator exactly one field/suffix pair    Tests whether a string field ends with a given suffix. Accepts exactly one field.
Parameters #     Parameter Type Description     field name string The suffix the field must end with.    Examples #  suffix: filename: &#34;.log&#34; Notes #  Inside a per-record sub-chain (e."
---
