...
title: "and"
date: 0001-01-01
summary: "and #     Kind Accepts     Logical operator a list of nested conditions    Evaluates to true only when all inner conditions are true. Uses short-circuit evaluation — stops checking on the first false.
Parameters #     Parameter Type Description     (list) list of conditions Nested condition blocks; every one must match.    Examples #  and: - equals: _ctx."
---
