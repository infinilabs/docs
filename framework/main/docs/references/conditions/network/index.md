...
title: "network"
date: 0001-01-01
summary: "network #     Kind Accepts     Value operator one field and named networks or CIDRs    Tests whether an IP address field belongs to a specific network. Accepts named network identifiers or CIDR notation; multiple networks can be given as a list, matching when the address belongs to any of them.
Parameters #     Parameter Type Description     loopback named Loopback addresses (e."
---
