...
title: "or"
date: 0001-01-01
summary: "or #     Kind Accepts     Logical operator a list of nested conditions    Evaluates to true when any inner condition is true. Uses short-circuit evaluation — stops checking on the first true.
Parameters #     Parameter Type Description     (list) list of conditions Nested condition blocks; at least one must match.    Examples #  or: - equals: _ctx."
---
