...
title: "equals"
date: 0001-01-01
summary: "equals #     Kind Accepts     Value operator one or more field/equality pairs    Tests whether a field value is exactly equal to an expected value. Supports string, int, float, and bool types. When multiple fields are specified, all must match (implicit AND).
Parameters #     Parameter Type Description     field name any scalar The expected value for that field."
---
