...
title: "Security"
date: 0001-01-01
summary: "Security #  Introduction #  INFINI Console Security provides the following security benefits and capabilities:
 ...
 Platform Role，used to control platform privileges Data Role, used to control data privileges  INFINI Console Security is enabled by default，and we can disable it by configure section web&gt;auth&gt;enabled to false in config file cosnole."
---
