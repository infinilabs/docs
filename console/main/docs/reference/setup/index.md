...
title: "Setup wizard"
date: 0001-01-01
summary: "Setup wizard #  Introduction #  After the initial install, it will enter the initialization guide page where you need to initialize some configurations, such as system cluster and default user。
Configuration #  Connecting to system cluster (elasticsearch required version 5.3 or above).
  TLS
