...
title: "Helm 部署"
date: 0001-01-01
summary: "Helm 部署 #  INFINI Console 支持 Helm 方式部署。
...
安装 #  helm install console infinilabs/console -n &lt;namespace&gt; 卸载 #  helm uninstall console -n &lt;namespace&gt; kubectl delete pvc console-data-console-0 console-config-console-0 -n &lt;namespace&gt; "
---
