...
date: 0001-01-01
summary: "How to easily create an Elasticsearch &ldquo;guest&rdquo; user #  Introduction #  In some cases, we want to share some functions or data with customers, but do not want the data to be modified. At this point we need to create a &ldquo;guest&rdquo; user. This article briefly describes how to create a &ldquo;guest&rdquo; user using the INFINI Console.
