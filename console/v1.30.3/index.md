...
date: 0001-01-01
summary: "INFINI Console #  Introduction #  INFINI Console is a very lightweight multi-cluster, cross-version unified Elasticsearch/OpenSearch monitoring &amp; alerting tool. Through the centralized management of Elasticsearch, you can quickly and conveniently manage multiple sets of Elasticsearch/OpenSearch clusters within the enterprise.
Architecture #  Features #   INFINI Console - The Choice of Elasticsearch Professionals. Be an Elasticsearch Pro Today!
  Support multi-cluster management, you can manage any number of clusters at the same time in one platform; Supports multiple versions of Easysearch (1."
---
