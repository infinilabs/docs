...
date: 0001-01-01
summary: "INFINI Loadgen #  Introduction #  INFINI Loadgen is a lightweight performance testing tool specifically designed for Easysearch, Elasticsearch, and OpenSearch.
Features #   Robust performance Lightweight and dependency-free Random selection of template-based parameters High concurrency Balanced traffic control at the benchmark end Validate server responses.  Getting Started Now  Community #  Fell free to join the Discord server to discuss anything around this project:
 Discord Server"
---
