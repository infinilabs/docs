...
title: "旧插件向量字段建模"
date: 0001-01-01
description: "旧 k-NN 插件的向量字段设计、维度选择、模型选型与写入策略。"
summary: "旧插件向量字段建模 #   本页的模型选型和示例面向旧 k-NN 插件。Easysearch 2.4.0 原生 HNSW 使用 dense_vector，参考 dense_vector 字段类型。
...
PUT /hybrid-index { &#34;mappings&#34;: { &#34;properties&#34;: { &#34;title&#34;: { &#34;type&#34;: &#34;text&#34; }, &#34;content&#34;: { &#34;type&#34;: &#34;text&#34; }, &#34;embedding&#34;: { &#34;type&#34;: &#34;knn_dense_float_vector&#34;, &#34;knn&#34;: { &#34;dims&#34;: 768, &#34;model&#34;: &#34;lsh&#34;, &#34;similarity&#34;: &#34;cosine&#34;, &#34;L&#34;: 99, &#34;k&#34;: 1 } } } } } 这样同一份文档既支持 BM25 全文搜索，也支持 kNN 向量搜索，为 复合查询打基础。"
---


# 旧插件向量字段建模

> 本页的模型选型和示例面向旧 k-NN 插件。Easysearch 2.4.0 原生 HNSW 使用 `dense_vector`，参考
...
这样同一份文档既支持 BM25 全文搜索，也支持 kNN 向量搜索，为 [复合查询](./vector-search.md#复合查询)打基础。
...
- [向量搜索指南](./vector-search.md)：完整的查询用法、复合查询、性能调优
