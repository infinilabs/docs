...
- cluster:admin/model_provider/get
- cluster:admin/model_provider/search
- cluster:admin/model_provider/write
- cluster:admin/model_provider/update
- cluster:admin/model_provider/delete
- cluster:admin/rules/get
- cluster:admin/rules/list
- cluster:admin/rules/import
- cluster:admin/rules/references
- cluster:admin/rules/compile
- cluster:admin/rules/simulate
- cluster:admin/rules/delete
