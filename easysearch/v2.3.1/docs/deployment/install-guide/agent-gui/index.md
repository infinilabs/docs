...
5. 登录 Agent
   ...
   见[服务管理登录]({{< relref "/docs/management/service-management/login.md" >}})

6. 创建 Easysearch 集群

   图形化部署支持 2 种创建集群的方式，见:

   1. [创建开发模式集群]({{< relref "/docs/management/service-management/create-dev-cluster.md" >}})
   2. [创建生产模式集群]({{< relref "/docs/management/service-management/create-prod-cluster.md" >}})
