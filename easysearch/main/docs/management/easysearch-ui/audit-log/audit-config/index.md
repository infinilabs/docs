...
![](/img/easysearch-ui/audit-log/audit-config/image-1.png)
...
![](/img/easysearch-ui/audit-log/audit-config/image-2.png)
...
![](/img/easysearch-ui/audit-log/audit-config/image-3.png)

5. **保存配置**：完成所有配置后，点击弹窗右下角的「保存」按钮，生效审计规则。

![](/img/easysearch-ui/audit-log/audit-config/image-4.png)
